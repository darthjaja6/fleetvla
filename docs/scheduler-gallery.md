...
The test suite also checks the discrete L=1 transition, priority-tier candidate
set, batch sizes one through three, per-candidate scores, and selected batches
against a [golden fixture](../tests/fixtures/armory_lookahead_l1_golden.json)
...
| Lookahead (fast weight 5) | 1,294 | 35.3% | 92.0% | 63.0% | [`JSON`](../benchmarks/results/armory-one-fast/armory-one-fast-l40s-lookahead-s0.json) |
